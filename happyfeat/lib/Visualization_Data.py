...
def Reorder_plusplus(Rsquare, signTab, electrodes_orig, powerLeft, powerRight, timefreqLeft, timefreqRight):
    ...
    # TODO : switch between reordering cases in a smarter way!
    ...
    elif len(electrodes_orig) >= 64:  # typical case...?
    ...
    elif len(electrodes_orig) == 61:  # BCINET, without electrodes FT9, FT10, Iz
        electrodes_target = ['Fp1','AF7','AF3','F7','F5','F3','F1','FT7','FC5','FC3','FC1','T7','C5','C3','C1','TP7','CP5','CP3','CP1','P7','P5','P3','P1','PO7','PO3','O1','Fpz','AFz','Fz','FCz','Cz','CPz','Pz','POz','Oz','Fp2','AF8','AF4','F8','F6','F4','F2','FT8','FC6','FC4','FC2','T8','C6','C4','C2','TP8','CP6','CP4','CP2','P8','P6','P4','P2','PO8','PO4','O2']
    else:
